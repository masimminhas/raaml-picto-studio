 ...
 * </p>
 * <ul>
 *   <li>{@link raaml.core.impl.AbstractEventImpl#getLikelihood <em>Likelihood</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractEventImpl extends AnySituationImpl implements AbstractEvent {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ABSTRACT_EVENT;
	}
	...
	public void setLikelihood(double newLikelihood) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ABSTRACT_EVENT__LIKELIHOOD, oldLikelihood, likelihood));
	}
