...
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	protected LibrarySwitch<Adapter> modelSwitch =
		new LibrarySwitch<Adapter>() {
			@Override
			public Adapter caseGeneralLibrary(GeneralLibrary object) {
				return createGeneralLibraryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link raaml.library.GeneralLibrary <em>General Library</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGeneralLibraryAdapter() {
		return null;
	}
