...
import raaml.core.provider.AbstractRiskItemProvider;
...
/**
 * This is the item provider adapter for a {@link raaml.hara.HazardousEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HazardousEventItemProvider extends AbstractRiskItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HazardousEvent_ASIL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HazardousEvent_ASIL_feature", "_UI_HazardousEvent_type"),
				 HaraPackage.Literals.HAZARDOUS_EVENT__ASIL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HaraPackage.Literals.HAZARDOUS_EVENT__HAZARDS);
			childrenFeatures.add(HaraPackage.Literals.HAZARDOUS_EVENT__SCENARIOS);
			childrenFeatures.add(HaraPackage.Literals.HAZARDOUS_EVENT__VEHICLE_LEVEL_EFFECTS);
			childrenFeatures.add(HaraPackage.Literals.HAZARDOUS_EVENT__SYSTEM_LEVEL_EFFECTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HaraPackage.Literals.HAZARDOUS_EVENT__HAZARDS,
