...
/**
 * This is the item provider adapter for a {@link raaml.stpa.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerItemProvider extends CoreSafetyElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StpaPackage.Literals.CONTROLLER__CONTROL_ACTIONS);
			childrenFeatures.add(StpaPackage.Literals.CONTROLLER__FEEDBACK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StpaPackage.Literals.CONTROLLER__CONTROL_ACTIONS,
				 StpaFactory.eINSTANCE.createControlAction()));

		newChildDescriptors.add
			(createChildParameter
				(StpaPackage.Literals.CONTROLLER__FEEDBACK,
