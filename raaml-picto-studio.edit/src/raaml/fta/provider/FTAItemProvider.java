...
/**
 * This is the item provider adapter for a {@link raaml.fta.FTA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FTAItemProvider extends AnalysisItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FTAItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FtaPackage.Literals.FTA__GATES);
			childrenFeatures.add(FtaPackage.Literals.FTA__EVENTS);
			childrenFeatures.add(FtaPackage.Literals.FTA__TREES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FTA"));
	}
	...
	public String getText(Object object) {
		String label = ((FTA)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FTA_type") :
			getString("_UI_FTA_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FTA.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FtaPackage.Literals.FTA__GATES,
		...
		newChildDescriptors.add
			(createChildParameter
				(FtaPackage.Literals.FTA__EVENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(FtaPackage.Literals.FTA__TREES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == FtaPackage.Literals.FTA__EVENTS ||
			childFeature == FtaPackage.Literals.FTA__GATES ||
			childFeature == FtaPackage.Literals.FTA__TREES;
