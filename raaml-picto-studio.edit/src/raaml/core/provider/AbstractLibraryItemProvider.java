...
/**
 * This is the item provider adapter for a {@link raaml.core.AbstractLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractLibraryItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbstractLibraryItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.ABSTRACT_LIBRARY__ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractLibrary_type") :
			getString("_UI_AbstractLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractLibrary.class)) {
			case CorePackage.ABSTRACT_LIBRARY__ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.ABSTRACT_LIBRARY__ELEMENTS,
